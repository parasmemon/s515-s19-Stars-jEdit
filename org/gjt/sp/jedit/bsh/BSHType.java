	...
	implements BshClassManager.Listener
{
	...
	*/
	...
	{
		if (clas.equals(Boolean.TYPE)) return "Z";
		if (clas.equals(Character.TYPE)) return "C";
		if (clas.equals(Byte.TYPE)) return "B";
		if (clas.equals(Short.TYPE)) return "S";
		if (clas.equals(Integer.TYPE)) return "I";
		if (clas.equals(Long.TYPE)) return "J";
		if (clas.equals(Float.TYPE)) return "F";
		if (clas.equals(Double.TYPE)) return "D";
		if (clas.equals(Void.TYPE)) return "V";
